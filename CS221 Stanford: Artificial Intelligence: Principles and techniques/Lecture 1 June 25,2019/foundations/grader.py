...
### Problem 0
grader.addManualPart('0a', maxPoints=2, description='piecewise absolute value with transformations')
grader.addManualPart('0b', maxPoints=2, description='indicator function primes')
...
############################################################
# Problem 4g: computeLongestPalindrome
